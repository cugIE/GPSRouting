					...
					<div class="row">		
						...
						<div class="panel">
							<div class="panel-heading bk-bg-primary">
								<h6>
									<i class="fa fa-table red"></i><span class="break"></span>修改网站参数
								</h6>
							...
							<div class="panel-body">
								...
								<form class="form-horizontal "
									action="ManageSystemServlet?action=updatesite2" method="post">
									<div class="form-group">
										<label class=" col-md-4 control-label">网站窗口标题</label>
										<div class="col-md-5">
											<input type="text" id="site_title" name="site_title"
												value=<%=site.getWebtitle() %> class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class=" col-md-4 control-label" for="text-input">网站广告标题</label>
										<div class="col-md-5">
											<input type="text" id="site_ad" name="site_ad"
												value=<%=site.getWebad() %> class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class="  col-md-4 control-label" for="text-input">网站页脚文字</label>
										<div class="col-md-5">
											<input type="text" id="site_word" name="site_word"
												class="form-control" value=<%=site.getWebword() %> />
										</div>
									</div>

									<div class="form-group">
										<label class="  col-md-4 control-label" for="text-input">网站所属单位</label>
										<div class="col-md-5">
											<input type="text" id="site_com" name="site_com"
												value=<%=site.getComname() %> class="form-control" />
										</div>
									</div>
									<br>
