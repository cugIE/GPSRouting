								...
								<form action="<%=request.getContextPath() %>/LoginServlet" method="post">
									...
									<div class="row">
										...
										<div class="col-sm-4 text-right">
											...
											<button type="submit" class="btn btn-primary btn-block btn-lg visible-xs bk-margin-top-10">登录</button>
										</div>
									</div>
									</form>	
									<br />
									...
									<div class="bk-margin-bottom-10 bk-margin-top-10 text-center">
										<button  href = "index.jsp" class="btn btn-primary hidden-xs">宾客访问</button>									
									</div>
									<br />
							</div>
						</div>
