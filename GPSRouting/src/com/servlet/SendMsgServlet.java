...
public class SendMsgServlet extends HttpServlet {
	...
	public static void start(HttpServletRequest req,HttpServletResponse res) 
			throws PushClientException,PushServerException, IOException{
		...
		String apiKey = "Gnqgc6nhdMQ0qz7itHQ9tBP4";
		String secretKey = "jweULkq4dPDbEh2LKnrgMQwhGnTSVswa";
